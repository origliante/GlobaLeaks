...
bigfile = file('1G.test', 'r')

data = bigfile.read(1024*10*10)
#data = bigfile.read()
#outname = '100M.out'
outname = '1024_10_10_2.out'

msg = pgpy.PGPMessage.new( data, compression=0x00 )
enc = ak.encrypt(msg, compression=0x00 )
out = file(outname, 'w+')
out.write( str( enc ) )
